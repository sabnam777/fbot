...
This Bot forward all files one One Public/private channel to Your Personal channel
More details /help</i>"""
  CAPTION = "`{}`\n\n" + str(Config.CAPTION)
...
<b>Credit :</b> @nobody_ismy_name 
<b>Language :</b> <code>Python3</code>
<b>Lybrary :</b> <code>v2.0.106</code>
<b>Server :</b> <code>Heroku</code>
<b>Build :</b> <code>V2.0</code>"""
  FROM_MSG = "<b><u>SET FROM CHANNEL USERNAME</b></u>\n<b>Enter From Channel channel id(suports both private and public) </b>\n<code>eg: -100xxxxxxxxxx</code>\n/cancel <code>- Cancel this process</code>"
  ...
  USERNAME = "<b>Send channel ID only </b>\n<code>eg: -100xxxxxxxxxx (private or public)</code> or -100xxxxxxxxxx for private channel\n<b>Enter /run Again</b>"
